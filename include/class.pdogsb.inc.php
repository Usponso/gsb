...
*/
	public function getInfosVisiteur($login, $mdp){
		$req = "select visiteur.id as id, visiteur.nom as nom, visiteur.prenom as prenom, statut.libelle from visiteur inner join statut on visiteur.statut = statut.idStatut
